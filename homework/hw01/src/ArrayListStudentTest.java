...
public class ArrayListStudentTest {
    ...
    public void testIncreaseCapacity() {
        ...
        int length = ((Object[]) (list.getBackingArray())).length;
        ...
        assertEquals("9a", list.get(9));
        assertEquals("10a", list.get(10));
    }
    ...
    public void testAllOperations() {
        ...
        list.addToFront("11a");                        // 11a, 0a, 1a, ...
        assertEquals("0a", list.removeAtIndex(1));  // 11a, 1a, 2a, ...
        list.addAtIndex(2, "12a");

        assertEquals(12, list.size());
        assertEquals("11a", list.get(0));
        assertEquals("12a", list.get(2));
